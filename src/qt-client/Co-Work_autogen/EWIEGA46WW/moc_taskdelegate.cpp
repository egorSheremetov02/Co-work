...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                     \
      len, qptrdiff(offsetof(qt_meta_stringdata_TaskDelegate_t, stringdata0) + \
...
static const qt_meta_stringdata_TaskDelegate_t qt_meta_stringdata_TaskDelegate =
    {{
         ...
         QT_MOC_LITERAL(1, 13, 6),  // "commit"
         QT_MOC_LITERAL(2, 20, 0)   // ""

     },
     "TaskDelegate\0commit\0"};
...
void TaskDelegate::qt_static_metacall(QObject *_o,
                                      QMetaObject::Call _c,
                                      int _id,
                                      void **_a) {
...
QT_INIT_METAOBJECT const QMetaObject TaskDelegate::staticMetaObject = {
    {&QStyledItemDelegate::staticMetaObject,
     qt_meta_stringdata_TaskDelegate.data, qt_meta_data_TaskDelegate,

...
#define QT_MOC_LITERAL(idx, ofs, len)                                      \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                 \
      len, qptrdiff(offsetof(qt_meta_stringdata_TaskList_t, stringdata0) + \
...
void TaskList::qt_static_metacall(QObject *_o,
                                  QMetaObject::Call _c,
                                  int _id,
                                  void **_a) {
  Q_UNUSED(_o);
...
QT_INIT_METAOBJECT const QMetaObject TaskList::staticMetaObject = {
    {&QAbstractListModel::staticMetaObject, qt_meta_stringdata_TaskList.data,
     qt_meta_data_TaskList, qt_static_metacall, nullptr, nullptr}};
